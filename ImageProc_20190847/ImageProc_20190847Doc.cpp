...
// ImageProc_20190847Doc.cpp: CImageProc20190847Doc 클래스의 구현
//
...
// CImageProc20190847Doc

IMPLEMENT_DYNCREATE(CImageProc20190847Doc, CDocument)

BEGIN_MESSAGE_MAP(CImageProc20190847Doc, CDocument)
END_MESSAGE_MAP()


// CImageProc20190847Doc 생성/소멸

CImageProc20190847Doc::CImageProc20190847Doc() noexcept
{
...
CImageProc20190847Doc::~CImageProc20190847Doc()
{
	if (inputImg != NULL) 
	{
...
BOOL CImageProc20190847Doc::OnNewDocument()
{
...
// CImageProc20190847Doc serialization

void CImageProc20190847Doc::Serialize(CArchive& ar)
{
...
// 축소판 그림을 지원합니다.
void CImageProc20190847Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CImageProc20190847Doc::InitializeSearchContent()
{
...
void CImageProc20190847Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
...
// CImageProc20190847Doc 진단

#ifdef _DEBUG
void CImageProc20190847Doc::AssertValid() const
{
	CDocument::AssertValid();
}

void CImageProc20190847Doc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
...
// CImageProc20190847Doc 명령


void CImageProc20190847Doc::LoadImageFile(CArchive& ar)
{
	// TODO: 여기에 구현 코드 추가.
...
void CImageProc20190847Doc::LoadSecondImageFile(CArchive& ar)
{
	// TODO: 여기에 구현 코드 추가.
