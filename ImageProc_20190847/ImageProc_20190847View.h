...
// ImageProc_20190847View.h: CImageProc20190847View 클래스의 인터페이스
//

#pragma once


class CImageProc20190847View : public CScrollView
{
protected: // serialization에서만 만들어집니다.
	CImageProc20190847View() noexcept;
	DECLARE_DYNCREATE(CImageProc20190847View)

// 특성입니다.
public:
	CImageProc20190847Doc* GetDocument() const;
...
// 구현입니다.
public:
	virtual ~CImageProc20190847View();
#ifdef _DEBUG
...
public:
	...
	void OnRegionMeaning();
};

#ifndef _DEBUG  // ImageProc_20190847View.cpp의 디버그 버전
inline CImageProc20190847Doc* CImageProc20190847View::GetDocument() const
   { return reinterpret_cast<CImageProc20190847Doc*>(m_pDocument); }
#endif
